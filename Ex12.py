...
class Questao12:
    def aplicar_lemmatization(self):
        ...
        palavras_lemma = [lemmatizer.lemmatize(palavra) for palavra in palavras]

        print("\nTexto com lemmatization:")
        print(" ".join(palavras_lemma))

if __name__ == "__main__":
    questao = Questao12()
    questao.aplicar_lemmatization()
